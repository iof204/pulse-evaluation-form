...
export const evaluationQuestions: EvaluationQuestion[] = [
  {
    ...
    answers: [
      option("awareness", "Build awareness", "Help more people discover our business."),
      option("leads", "Generate leads", "Generate more leads or inquiries."),
      option("sales", "Increase sales", "Increase sales, bookings, or appointments."),
      option("launch", "Support a launch", "Launch a new business, product, service, or location."),
      option("retention", "Improve retention", "Improve customer retention or repeat business."),
      option("foundation", "Strengthen our foundation", "Strengthen our overall marketing foundation."),
      option("consistency", "Become more consistent", "Become more consistent with our marketing."),
      option("priorities", "Clarify our priorities", "We have several goals and are not sure what should come first."),
    ],
  },
  {
    id: 2,
