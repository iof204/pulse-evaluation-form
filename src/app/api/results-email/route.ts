    ...
    await transporter.sendMail({
      ...
      html: `<div style="margin:0;background:#f7f4f9;padding:32px 16px;font-family:Arial,sans-serif"><main style="max-width:680px;margin:0 auto">
        ...
        <section style="margin-top:36px;padding:28px 8px 6px;text-align:left">
          ...
          <a href="${evaluationUrl}" style="display:inline-block;margin:0 8px 8px 0;padding:11px 16px;border-radius:10px;background:#7c4d9e;color:#fff;font-size:13px;font-weight:600;text-decoration:none">Take the Evaluation</a>
          <a href="mailto:?subject=${encodeURIComponent("Take the Ecko Marketing Pulse Evaluation")}&amp;body=${encodedShareCopy}%0A%0A${encodedEvaluationUrl}" style="display:inline-block;margin:0 8px 8px 0;padding:11px 16px;border:1px solid #ddd4e3;border-radius:10px;background:#fff;color:#633485;font-size:13px;font-weight:600;text-decoration:none">Email</a>
          <a href="https://www.facebook.com/sharer/sharer.php?u=${encodedEvaluationUrl}" style="display:inline-block;margin:0 8px 8px 0;padding:11px 14px;border:1px solid #ddd4e3;border-radius:10px;background:#fff;color:#633485;font-size:13px;font-weight:600;text-decoration:none">Facebook</a>
          <a href="https://x.com/intent/post?url=${encodedEvaluationUrl}&amp;text=${encodedShareCopy}" style="display:inline-block;margin:0 8px 8px 0;padding:11px 14px;border:1px solid #ddd4e3;border-radius:10px;background:#fff;color:#633485;font-size:13px;font-weight:600;text-decoration:none">X</a>
          <a href="https://www.linkedin.com/sharing/share-offsite/?url=${encodedEvaluationUrl}" style="display:inline-block;margin:0 0 8px;padding:11px 14px;border:1px solid #ddd4e3;border-radius:10px;background:#fff;color:#633485;font-size:13px;font-weight:600;text-decoration:none">LinkedIn</a>
        </section>
